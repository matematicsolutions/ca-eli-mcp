...
Pulls a tiny static ``ca-runtime.json.gz`` from this repo's GitHub Release on
first tool call so a dead endpoint can be repointed (edit runtime/ca-runtime.json
...
Opt-out: set ``CA_ELI_RUNTIME_URL=""`` to disable the fetch.
"""
...
MANIFEST_URL = os.environ.get(
    "CA_ELI_RUNTIME_URL",
    "https://github.com/matematicsolutions/ca-eli-mcp/releases/latest/download/ca-runtime.json.gz",
)
_CACHE_NAME = "ca-runtime.json"
_TIMEOUT = 15
_USER_AGENT = "ca-eli-mcp-runtime (+https://github.com/matematicsolutions/ca-eli-mcp)"
